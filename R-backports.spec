...
Version  : 1.1.6
Release  : 48
URL      : https://cran.r-project.org/src/contrib/backports_1.1.6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/backports_1.1.6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586274812
